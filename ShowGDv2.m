function ShowGDv2(method_name,x_list,y_list)
    ...
    quiver3(x_list(1:end-1),y_list(1:end-1),D2_locz.*ones(m,n-1),u,v,zeros(m,n-1),'r','LineWidth',2,'MaxHeadSize',0.5,'AutoScale','off');hold on; % ,'AutoScaleFactor',scale,'AutoScale','on'
